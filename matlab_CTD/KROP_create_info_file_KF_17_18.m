...
mooring_id='KF_17_18';
start_date=datenum('16-Aug-2017 22:00:00');
end_date=datenum('17-Aug-2018 06:00:00');
moor_lat_deg = 78; moor_lat_min = 57.536;
moor_lon_deg = 11; moor_lon_min = 49.436;
mooring_depth = 229;
...
% conductivity
off_sbe16p_t = 0; % No imtercomparison performed
off_sbe16p_c = 0; % No imtercomparison performed
% Cal dates
sbe16p_p_cal_date = {'29-Jun-2017'};
sbe16p_t_cal_date = {'05-Jul-2017'};
sbe16p_c_cal_date = {'05-Jul-2017'};
% Other sensors
...
sbe37_depth    = {'33' '217'}; % if more than 1 use format {'20' '30'}
% Pressure sensor: 0 = not attached, 1 = attached. If more than one sbe37 
% on the mooring use format [1;1]
sbe37_p = [0;1]; 
% Offsets determined after intercomparison casts. t = temperature, c =
% conductivity
off_sbe37_t = [0;0]; % From intercomparison 15/08/2017
off_sbe37_c = [0;0]; % From intercomparison 15/08/2017
% Cal
...
sbe56_depth    = {'38'   '48'   '59'   '80'   '103'  '126'  '156'  '186'  '217.1' };
% Offsets determined after intercomparison casts. t = temperature, c =
% conductivity
