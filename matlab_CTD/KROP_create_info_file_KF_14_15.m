...
mooring_id='KF_14_15';
start_date=datenum('25-Sep-2014 21:00:00');
end_date=datenum('10-Sep-2015 15:00:00');
moor_lat_deg = 78; moor_lat_min = 57.760;
moor_lon_deg = 11; moor_lon_min = 47.835;
mooring_depth = 215;
...
sbe16p_depth    = {'23'}; % if more than 1 use format {'20' '30'}
...
sbe37_depth    = {  '13'  '201'}; % if more than 1 use format {'20' '30'}
% Pressure sensor: 0 = not attached, 1 = attached. If more than one sbe37 
% on the mooring use format [1;1]
sbe37_p = [1;1]; 
% Offsets determined after intercomparison casts. t = temperature, c =
% conductivity
off_sbe37_t = [0;0]; % From intercomparison 17/09/2015
off_sbe37_c = [0;0]; % From intercomparison 17/09/2015
% Cal
sbe37_cal_date = {'26-Jun-2011' '26-Jun-2011'};

% SBE56
sbe56_num      = 9; % number of sbe56 on mooring, 0 if none
sbe56_sn       = {'2660' '2661' '2662' '2663' '2664' '2665' '2666' '2667' '2668'};
sbe56_depth    = {'13.1' '23.1'   '34'   '47'   '59'   '90'  '121'  '151' '200.9'};
% Offsets determined after intercomparison casts. t = temperature, c =
% conductivity
off_sbe56_t = [0;NaN;0;0;NaN;NaN;NaN;0;NaN]; % From intercomparisons 25 and 29/08/2016
% Cal
sbe56_cal_date = {'31-Jul-2013' '31-Jul-2013' '31-Jul-2013'  '31-Jul-2013' '31-Jul-2013' '31-Jul-2013' '31-Jul-2013' '31-Jul-2013' '31-Jul-2013'};
