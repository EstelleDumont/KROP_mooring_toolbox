...
% Delete avg structure if it already exists
if exist('PRO_avg_6hr','var'); clear('PRO_avg_6hr'); end
if isfield('PRO_grid_temp','var'); clear('PRO_grid_temp'); end
            ...
            for ind=1:length(interp_time)
                ...
                for k=1:length(var_list)
                    ...
                    if ~isempty(ind_avg)
                        ...
                        eval(['DATA_OUT.' var_name '(ind,1)=NaN;']);
                    end
                end
