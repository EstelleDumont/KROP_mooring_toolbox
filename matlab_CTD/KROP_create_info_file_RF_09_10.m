...
mooring_id='RF_09_10';
start_date=datenum('31-Aug-2009 14:00:00');
end_date=datenum('19-Sep-2010 12:00:00');
moor_lat_deg = 80; moor_lat_min = 17.034;
moor_lon_deg = 22; moor_lon_min = 18.149;
mooring_depth = 218;
...
sbe16p_sn       = {'6067' '6101'}; % if more than one use format {'1111' '1112'}
sbe16p_depth    = {  '12' '26.5'}; % if more than 1 use format {'20' '30'}
...
% conductivity
off_sbe16p_t = [NaN;NaN]; % no intercomparison data available
off_sbe16p_c = [NaN;NaN]; % no intercomparison data available
% Cal dates and sensor details
sbe16p_p_cal_date = {'09-May-2008' '22-Jul-2008'};
sbe16p_t_cal_date = {'22-Jul-2008' '24-Jul-2008'};
sbe16p_c_cal_date = {'22-Jul-2008' '24-Jul-2008'};
% Other sensors
sbe16p_flc = [1;1]; % Fluorescence
sbe16p_flc_sn = {'2354' '2352'};
sbe16p_flc_type = {'Seapoint' 'Seapoint'};
sbe16p_flc_cal_date = {'08-Feb-2001' '08-Feb-2001'};
sbe16p_par = [1;1]; % PAR
sbe16p_par_sn = {'70190' '70191'};
sbe16p_par_type = {'Biospherical' 'Biospherical'};
sbe16p_par_cal_date = {'21-Jul-2008' '07-Aug-2008'};
...
sbe37_sn       = {'5509'  '5510' '5511'}; % if more than one use format {'1111' '1112'}
sbe37_depth    = {'16.5' '103.5'  '211'}; % if more than 1 use format {'20' '30'}
...
% conductivity 
off_sbe37_t = [0;0;0]; % intercomparison 2010 
off_sbe37_c = [0;0;0]; % intercomparison 2010 
sbe37_cal_date = {'11-Aug-2007' '11-Aug-2007' '11-Aug-2007'}; 
...
ml_sn       = {'1592' '1593' '1598' '1623' '1691'  '6176'  '6178'};
ml_depth    = {'37.5' '47.5' '62.5' '78.5' '130.5' '156.5' '186'};
