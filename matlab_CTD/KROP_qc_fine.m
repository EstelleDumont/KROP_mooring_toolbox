function KROP_qc_fine(info_file)

% Despiking: second pass - fine level
% ESDU, SAMS, 2019
    ...
    if sbe16p_num >0
        ...
        for j = 1:sbe16p_num
            ...
            while dspk == 0
                ...
                fig_nm = [d_plot_qc '\despike_fine_' mooring_id '_' inst];
                ...
                if regexp(despike_ok,'Y','ignorecase')
                    ...
                    DATA_OUT.despiking_fine_avg_block=blk;
                    DATA_OUT.despiking_fine_avg_block=blk;
                    DATA_OUT.despiking_fine_tolerance_t=thr;
                    DATA_OUT.despiking_fine_tolerance_c=thr;
                    DATA_OUT.despiking_fine_tolerance_s=thr_s;
                    % Save data
                    eval(['PRO.' inst '=DATA_OUT;']);
                    dspk = 1;
                else
        ...
        for j = 1:ml_num
            ...
            while dspk == 0
                ...
                if regexp(despike_ok,'Y','ignorecase')
                    ...
                    % Record despiking parameters
                    DATA_OUT.despiking_fine_avg_block=blk;
                    DATA_OUT.despiking_fine_tolerance=thr;
                    % Save data
                    eval(['PRO.' inst '=DATA_OUT;']);
                    dspk = 1;
                else
...
%% Save final dataset
save(mat_fl,'RAW','RAW2','RAW3','RAW4','PRO');
